...
norm_max = Normalize(vmin=-0.2, vmax= 0.2)
...
def update(frame):
    ...
    #     plt.savefig("2D_TE_2_norm_test.png", dpi=300, bbox_inches='tight')
...
# Save the animation
#ani.save("2D_TE_2_norm_test.mp4", fps=45) #Must save before plt.show() but then additional waiting time
